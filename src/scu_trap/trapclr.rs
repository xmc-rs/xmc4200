...
pub type TEMPHIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRAPCLR_SPEC, TEMPHIT_AW, O>;
...
pub type TEMPLOT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRAPCLR_SPEC, TEMPLOT_AW, O>;
