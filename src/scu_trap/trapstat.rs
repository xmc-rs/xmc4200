...
#[doc = "Field `SOSCWDGT` reader - System OSC WDT Trap Status"]
...
#[doc = "Field `ULPWDGT` reader - OSC_ULP WDG Trap Status"]
...
#[doc = "Field `TEMPHIT` reader - Die Temperature Too High Trap Status"]
...
#[doc = "Field `TEMPLOT` reader - Die Temperature Too Low Trap Status"]
