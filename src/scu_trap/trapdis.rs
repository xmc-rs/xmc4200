...
pub type TEMPHIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRAPDIS_SPEC, TEMPHIT_A, O>;
impl<'a, const O: u8> TEMPHIT_W<'a, O> {
    #[doc = "Trap request enabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type TEMPLOT_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRAPDIS_SPEC, TEMPLOT_A, O>;
impl<'a, const O: u8> TEMPLOT_W<'a, O> {
    #[doc = "Trap request enabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn temphit(&mut self) -> TEMPHIT_W<12> {
        TEMPHIT_W::new(self)
    }
    #[doc = "Bit 13 - Die Temperature Too Low Trap Disable"]
    #[inline(always)]
    #[must_use]
    pub fn templot(&mut self) -> TEMPLOT_W<13> {
        TEMPLOT_W::new(self)
    }
...
impl crate::Resettable for TRAPDIS_SPEC {
    const RESET_VALUE: Self::Ux = 0x31ff;
}
