...
impl From<Temphit> for bool {
    #[inline(always)]
    fn from(variant: Temphit) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TEMPHIT` reader - Die Temperature Too High Trap Disable"]
pub type TemphitR = crate::BitReader<Temphit>;
impl TemphitR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Temphit {
        match self.bits {
            false => Temphit::Value1,
            true => Temphit::Value2,
        }
    }
    #[doc = "Trap request enabled"]
...
pub type TemphitW<'a, REG> = crate::BitWriter<'a, REG, Temphit>;
impl<'a, REG> TemphitW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Trap request enabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Temphit::Value1)
    }
    #[doc = "Trap request disabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Temphit::Value2)
    }
}
...
impl From<Templot> for bool {
    #[inline(always)]
    fn from(variant: Templot) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `TEMPLOT` reader - Die Temperature Too Low Trap Disable"]
pub type TemplotR = crate::BitReader<Templot>;
impl TemplotR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Templot {
        match self.bits {
            false => Templot::Value1,
            true => Templot::Value2,
        }
    }
    #[doc = "Trap request enabled"]
...
pub type TemplotW<'a, REG> = crate::BitWriter<'a, REG, Templot>;
impl<'a, REG> TemplotW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Trap request enabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Templot::Value1)
    }
    #[doc = "Trap request disabled"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Templot::Value2)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn temphit(&mut self) -> TemphitW<TrapdisSpec> {
        TemphitW::new(self, 12)
    }
    #[doc = "Bit 13 - Die Temperature Too Low Trap Disable"]
    #[inline(always)]
    #[must_use]
    pub fn templot(&mut self) -> TemplotW<TrapdisSpec> {
        TemplotW::new(self, 13)
    }
}
