...
impl<'a> LPACCR_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACCR_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> LPACTH0_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACTH0_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> LPACTH1_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACTH1_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> LPACST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACST_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> LPACCLR_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACCLR_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> LPACSET_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LPACSET_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> HINTST_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: HINTST_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> HINTCLR_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: HINTCLR_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl<'a> HINTSET_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: HINTSET_AW) -> &'a mut W {
        {
            self.bit(variant.into())
        }
    }
...
impl From<HDCRCLR_AW> for bool {
    ...
    fn from(variant: HDCRCLR_AW) -> Self {
        match variant {
            HDCRCLR_AW::VALUE1 => false,
            HDCRCLR_AW::VALUE2 => true,
        }
    }
}
...
impl From<HDCRSET_AW> for bool {
    ...
    fn from(variant: HDCRSET_AW) -> Self {
        match variant {
            HDCRSET_AW::VALUE1 => false,
            HDCRSET_AW::VALUE2 => true,
        }
    }
}
