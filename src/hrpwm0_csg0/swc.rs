...
impl W {
    ...
    #[inline(always)]
    pub fn cvls1(&mut self) -> CVLS1_W<'_, SWC_SPEC> {
        CVLS1_W::new(self, 0)
    }
    #[doc = "Bit 1 - Value switch from CSGyDSV2 to CSGyDSV1 status clear"]
    #[inline(always)]
    pub fn cvls2(&mut self) -> CVLS2_W<'_, SWC_SPEC> {
        CVLS2_W::new(self, 1)
    }
    #[doc = "Bit 2 - Conversion trigger status clear"]
    #[inline(always)]
    pub fn ctrgs(&mut self) -> CTRGS_W<'_, SWC_SPEC> {
        CTRGS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Start trigger status clear"]
    #[inline(always)]
    pub fn cstrs(&mut self) -> CSTRS_W<'_, SWC_SPEC> {
        CSTRS_W::new(self, 3)
    }
    #[doc = "Bit 4 - Stop trigger status clear"]
    #[inline(always)]
    pub fn cstps(&mut self) -> CSTPS_W<'_, SWC_SPEC> {
        CSTPS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Shadow transfer status clear"]
    #[inline(always)]
    pub fn cstd(&mut self) -> CSTD_W<'_, SWC_SPEC> {
        CSTD_W::new(self, 5)
    }
    #[doc = "Bit 6 - Comparator rise status clear"]
    #[inline(always)]
    pub fn ccrs(&mut self) -> CCRS_W<'_, SWC_SPEC> {
        CCRS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Comparator fall status clear"]
    #[inline(always)]
    pub fn ccfs(&mut self) -> CCFS_W<'_, SWC_SPEC> {
        CCFS_W::new(self, 7)
    }
    #[doc = "Bit 8 - Comparator clamped status clear"]
    #[inline(always)]
    pub fn ccss(&mut self) -> CCSS_W<'_, SWC_SPEC> {
        CCSS_W::new(self, 8)
    }
}
#[doc = "Service request SW clear\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`swc::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SWC_SPEC;
