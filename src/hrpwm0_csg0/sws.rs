...
impl W {
    ...
    #[inline(always)]
    pub fn svls1(&mut self) -> SVLS1_W<'_, SWS_SPEC> {
        SVLS1_W::new(self, 0)
    }
    #[doc = "Bit 1 - Value switch from CSGyDSV2 to CSGyDSV1 status set"]
    #[inline(always)]
    pub fn svls2(&mut self) -> SVLS2_W<'_, SWS_SPEC> {
        SVLS2_W::new(self, 1)
    }
    #[doc = "Bit 2 - Conversion trigger status set"]
    #[inline(always)]
    pub fn strgs(&mut self) -> STRGS_W<'_, SWS_SPEC> {
        STRGS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Start trigger status set"]
    #[inline(always)]
    pub fn sstrs(&mut self) -> SSTRS_W<'_, SWS_SPEC> {
        SSTRS_W::new(self, 3)
    }
    #[doc = "Bit 4 - Stop trigger status set"]
    #[inline(always)]
    pub fn sstps(&mut self) -> SSTPS_W<'_, SWS_SPEC> {
        SSTPS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Shadow transfer status set"]
    #[inline(always)]
    pub fn sstd(&mut self) -> SSTD_W<'_, SWS_SPEC> {
        SSTD_W::new(self, 5)
    }
    #[doc = "Bit 6 - Comparator rise status set"]
    #[inline(always)]
    pub fn scrs(&mut self) -> SCRS_W<'_, SWS_SPEC> {
        SCRS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Comparator fall status set"]
    #[inline(always)]
    pub fn scfs(&mut self) -> SCFS_W<'_, SWS_SPEC> {
        SCFS_W::new(self, 7)
    }
    #[doc = "Bit 8 - Comparator clamped state status set"]
    #[inline(always)]
    pub fn scss(&mut self) -> SCSS_W<'_, SWS_SPEC> {
        SCSS_W::new(self, 8)
    }
}
