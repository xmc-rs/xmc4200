...
pub type SVIS_W<'a, REG> = crate::FieldWriter<'a, REG, 4, SVIS_A, crate::Safe>;
...
pub type SCS_W<'a, REG> = crate::FieldWriter<'a, REG, 2, SCS_A, crate::Safe>;
...
#[doc = "External input selection\n\nYou can [`read`](crate::Reg::read) this register and get [`dci::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dci::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DCI_SPEC;
