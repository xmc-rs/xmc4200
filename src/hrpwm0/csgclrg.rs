...
impl W {
    ...
    #[inline]
    pub fn cd0r(&mut self) -> _CD0RW {
        _CD0RW { w: self }
    }
    #[doc = "Bit 1 - CMP0 run bit clear"]
    #[inline]
    pub fn cc0r(&mut self) -> _CC0RW {
        _CC0RW { w: self }
    }
    #[doc = "Bit 2 - CMP0 passive level clear"]
    #[inline]
    pub fn cc0p(&mut self) -> _CC0PW {
        _CC0PW { w: self }
    }
    #[doc = "Bit 4 - DAC1 run bit clear"]
    #[inline]
    pub fn cd1r(&mut self) -> _CD1RW {
        _CD1RW { w: self }
    }
    #[doc = "Bit 5 - CMP1 run bit clear"]
    #[inline]
    pub fn cc1r(&mut self) -> _CC1RW {
        _CC1RW { w: self }
    }
    ...
    #[inline]
    pub fn cd2r(&mut self) -> _CD2RW {
        _CD2RW { w: self }
    }
    #[doc = "Bit 9 - CMP2 run bit clear"]
    #[inline]
    pub fn cc2r(&mut self) -> _CC2RW {
        _CC2RW { w: self }
    }
