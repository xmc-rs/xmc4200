...
impl W {
    ...
    #[inline]
    pub fn sd0r(&mut self) -> _SD0RW {
        _SD0RW { w: self }
    }
    #[doc = "Bit 1 - CMP0 run bit set"]
    #[inline]
    pub fn sc0r(&mut self) -> _SC0RW {
        _SC0RW { w: self }
    }
    #[doc = "Bit 2 - CMP0 passive level set"]
    #[inline]
    pub fn sc0p(&mut self) -> _SC0PW {
        _SC0PW { w: self }
    }
    #[doc = "Bit 4 - DAC1 run bit set"]
    #[inline]
    pub fn sd1r(&mut self) -> _SD1RW {
        _SD1RW { w: self }
    }
    #[doc = "Bit 5 - CMP1 run bit set"]
    #[inline]
    pub fn sc1r(&mut self) -> _SC1RW {
        _SC1RW { w: self }
    }
    #[doc = "Bit 6 - CMP1 passive level set"]
    #[inline]
    pub fn sc1p(&mut self) -> _SC1PW {
        _SC1PW { w: self }
    }
    #[doc = "Bit 8 - DAC2 run bit set"]
    #[inline]
    pub fn sd2r(&mut self) -> _SD2RW {
        _SD2RW { w: self }
    }
    #[doc = "Bit 9 - CMP2 run bit set"]
    #[inline]
    pub fn sc2r(&mut self) -> _SC2RW {
        _SC2RW { w: self }
    }
