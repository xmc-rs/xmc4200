...
impl W {
    ...
    #[inline(always)]
    pub fn sd0r(&mut self) -> SD0R_W<'_, CSGSETG_SPEC> {
        SD0R_W::new(self, 0)
    }
    #[doc = "Bit 1 - CMP0 run bit set"]
    #[inline(always)]
    pub fn sc0r(&mut self) -> SC0R_W<'_, CSGSETG_SPEC> {
        SC0R_W::new(self, 1)
    }
    #[doc = "Bit 2 - CMP0 passive level set"]
    #[inline(always)]
    pub fn sc0p(&mut self) -> SC0P_W<'_, CSGSETG_SPEC> {
        SC0P_W::new(self, 2)
    }
    #[doc = "Bit 4 - DAC1 run bit set"]
    #[inline(always)]
    pub fn sd1r(&mut self) -> SD1R_W<'_, CSGSETG_SPEC> {
        SD1R_W::new(self, 4)
    }
    #[doc = "Bit 5 - CMP1 run bit set"]
    #[inline(always)]
    pub fn sc1r(&mut self) -> SC1R_W<'_, CSGSETG_SPEC> {
        SC1R_W::new(self, 5)
    }
    #[doc = "Bit 6 - CMP1 passive level set"]
    #[inline(always)]
    pub fn sc1p(&mut self) -> SC1P_W<'_, CSGSETG_SPEC> {
        SC1P_W::new(self, 6)
    }
    #[doc = "Bit 8 - DAC2 run bit set"]
    #[inline(always)]
    pub fn sd2r(&mut self) -> SD2R_W<'_, CSGSETG_SPEC> {
        SD2R_W::new(self, 8)
    }
    #[doc = "Bit 9 - CMP2 run bit set"]
    #[inline(always)]
    pub fn sc2r(&mut self) -> SC2R_W<'_, CSGSETG_SPEC> {
        SC2R_W::new(self, 9)
    }
    #[doc = "Bit 10 - CMP2 passive level set"]
    #[inline(always)]
    pub fn sc2p(&mut self) -> SC2P_W<'_, CSGSETG_SPEC> {
        SC2P_W::new(self, 10)
    }
}
