...
impl W {
    ...
    #[inline(always)]
    pub fn h0es(&mut self) -> H0ES_W<'_, HRCSTRG_SPEC> {
        H0ES_W::new(self, 0)
    }
    #[doc = "Bit 1 - HRC0 dead time value shadow transfer enable set"]
    #[inline(always)]
    pub fn h0des(&mut self) -> H0DES_W<'_, HRCSTRG_SPEC> {
        H0DES_W::new(self, 1)
    }
    #[doc = "Bit 4 - HRC1 high resolution values shadow transfer Enable Set"]
    #[inline(always)]
    pub fn h1es(&mut self) -> H1ES_W<'_, HRCSTRG_SPEC> {
        H1ES_W::new(self, 4)
    }
    #[doc = "Bit 5 - HRC0 dead time value shadow transfer enable set"]
    #[inline(always)]
    pub fn h1des(&mut self) -> H1DES_W<'_, HRCSTRG_SPEC> {
        H1DES_W::new(self, 5)
    }
    #[doc = "Bit 8 - HRC2 high resolution values shadow transfer Enable Set"]
    #[inline(always)]
    pub fn h2es(&mut self) -> H2ES_W<'_, HRCSTRG_SPEC> {
        H2ES_W::new(self, 8)
    }
    #[doc = "Bit 9 - HRC0 dead time value shadow transfer enable set"]
    #[inline(always)]
    pub fn h2des(&mut self) -> H2DES_W<'_, HRCSTRG_SPEC> {
        H2DES_W::new(self, 9)
    }
    #[doc = "Bit 12 - HRC3 high resolution values shadow transfer Enable Set"]
    #[inline(always)]
    pub fn h3es(&mut self) -> H3ES_W<'_, HRCSTRG_SPEC> {
        H3ES_W::new(self, 12)
    }
    #[doc = "Bit 13 - HRC0 dead time value shadow transfer enable set"]
    #[inline(always)]
    pub fn h3des(&mut self) -> H3DES_W<'_, HRCSTRG_SPEC> {
        H3DES_W::new(self, 13)
    }
}
#[doc = "Global HRC shadow trigger set\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hrcstrg::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
