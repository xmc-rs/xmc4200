...
#[doc = "Values that can be written to the field `HRPWM0`"]
pub enum HRPWM0W {
    #[doc = "No effect"]
    VALUE1,
    #[doc = "Disable gating"]
...
impl HRPWM0W {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            HRPWM0W::VALUE1 => false,
            HRPWM0W::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _HRPWM0W<'a> {
    w: &'a mut W,
}
impl<'a> _HRPWM0W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: HRPWM0W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(HRPWM0W::VALUE1)
    }
    #[doc = "Disable gating"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(HRPWM0W::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[inline]
    pub fn hrpwm0(&mut self) -> _HRPWM0W {
        _HRPWM0W { w: self }
    }
}
