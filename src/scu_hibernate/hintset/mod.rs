...
#[doc = "Values that can be written to the field `VCOREOFF`"]
pub enum VCOREOFFW {
    #[doc = "No effect"]
    VALUE1,
...
impl VCOREOFFW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            VCOREOFFW::VALUE1 => false,
            VCOREOFFW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _VCOREOFFW<'a> {
    w: &'a mut W,
}
impl<'a> _VCOREOFFW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: VCOREOFFW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(VCOREOFFW::VALUE1)
    }
    #[doc = "VDDC off to EVR set"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(VCOREOFFW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[inline]
    pub fn vcoreoff(&mut self) -> _VCOREOFFW {
        _VCOREOFFW { w: self }
    }
