...
pub type Hrpwm0rsR = crate::BitReader<Hrpwm0rs>;
impl Hrpwm0rsR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Hrpwm0rs {
        match self.bits {
            false => Hrpwm0rs::Value1,
            true => Hrpwm0rs::Value2,
        }
    }
    #[doc = "Reset de-asserted"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Hrpwm0rs::Value1
    }
    #[doc = "Reset asserted"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Hrpwm0rs::Value2
    }
}
impl R {
    ...
    pub fn hrpwm0rs(&self) -> Hrpwm0rsR {
        Hrpwm0rsR::new(((self.bits >> 23) & 1) != 0)
    }
}
