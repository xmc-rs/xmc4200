# ! [ cfg_attr ( feature = "rt" , feature ( global_asm ) ) ] # ! [ cfg_attr ( feature = "rt" , feature ( macro_reexport ) ) ] # ! [ cfg_attr ( feature = "rt" , feature ( used ) ) ] # ! [ doc = "Peripheral access API for XMC4200 microcontrollers (generated using svd2rust v0.11.4)\n\nYou can find an overview of the API [here].\n\n[here]: https://docs.rs/svd2rust/0.11.4/svd2rust/#peripheral-api" ] # ! [ deny ( missing_docs ) ] # ! [ deny ( warnings ) ] # ! [ allow ( non_camel_case_types ) ] # ! [ feature ( const_fn ) ] # ! [ no_std ]extern crate cortex_m ;
...
pub const HRPWM0: Peripheral<HRPWM0> = unsafe { Peripheral::new(1073875200) };
#[doc = "High Resolution PWM Unit"]
pub mod hrpwm0;
#[doc = "High Resolution PWM Unit"]
pub struct HRPWM0 {
    register_block: hrpwm0::RegisterBlock,
}
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_CSG0: Peripheral<HRPWM0_CSG0> = unsafe { Peripheral::new(1073875456) };
#[doc = "High Resolution PWM Unit"]
pub mod hrpwm0_csg0;
#[doc = "High Resolution PWM Unit"]
pub struct HRPWM0_CSG0 {
    register_block: hrpwm0_csg0::RegisterBlock,
}
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_CSG1: Peripheral<HRPWM0_CSG1> = unsafe { Peripheral::new(1073875712) };
#[doc = r" Register block"]
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_CSG2: Peripheral<HRPWM0_CSG2> = unsafe { Peripheral::new(1073875968) };
#[doc = r" Register block"]
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_HRC0: Peripheral<HRPWM0_HRC0> = unsafe { Peripheral::new(1073877760) };
#[doc = "High Resolution PWM Unit"]
pub mod hrpwm0_hrc0;
#[doc = "High Resolution PWM Unit"]
pub struct HRPWM0_HRC0 {
    register_block: hrpwm0_hrc0::RegisterBlock,
}
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_HRC1: Peripheral<HRPWM0_HRC1> = unsafe { Peripheral::new(1073878016) };
#[doc = r" Register block"]
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_HRC2: Peripheral<HRPWM0_HRC2> = unsafe { Peripheral::new(1073878272) };
#[doc = r" Register block"]
...
#[doc = "High Resolution PWM Unit"]
pub const HRPWM0_HRC3: Peripheral<HRPWM0_HRC3> = unsafe { Peripheral::new(1073878528) };
#[doc = r" Register block"]
...
pub struct Peripherals<'a> {
    ...
    pub HRPWM0: &'a HRPWM0,
    #[doc = "HRPWM0_CSG0"]
    pub HRPWM0_CSG0: &'a HRPWM0_CSG0,
    #[doc = "HRPWM0_CSG1"]
    pub HRPWM0_CSG1: &'a HRPWM0_CSG1,
    #[doc = "HRPWM0_CSG2"]
    pub HRPWM0_CSG2: &'a HRPWM0_CSG2,
    #[doc = "HRPWM0_HRC0"]
    pub HRPWM0_HRC0: &'a HRPWM0_HRC0,
    #[doc = "HRPWM0_HRC1"]
    pub HRPWM0_HRC1: &'a HRPWM0_HRC1,
    #[doc = "HRPWM0_HRC2"]
    pub HRPWM0_HRC2: &'a HRPWM0_HRC2,
    #[doc = "HRPWM0_HRC3"]
    pub HRPWM0_HRC3: &'a HRPWM0_HRC3,
    #[doc = "POSIF0"]
    pub POSIF0: &'a POSIF0,
    #[doc = "PORT0"]
    pub PORT0: &'a PORT0,
...
impl<'a> Peripherals<'a> {
    ...
    pub unsafe fn all() -> Self {
        Peripherals {
            ...
            HRPWM0: &*HRPWM0.get(),
            HRPWM0_CSG0: &*HRPWM0_CSG0.get(),
            HRPWM0_CSG1: &*HRPWM0_CSG1.get(),
            HRPWM0_CSG2: &*HRPWM0_CSG2.get(),
            HRPWM0_HRC0: &*HRPWM0_HRC0.get(),
            HRPWM0_HRC1: &*HRPWM0_HRC1.get(),
            HRPWM0_HRC2: &*HRPWM0_HRC2.get(),
            HRPWM0_HRC3: &*HRPWM0_HRC3.get(),
            POSIF0: &*POSIF0.get(),
            PORT0: &*PORT0.get(),
            PORT1: &*PORT1.get(),
            PORT2: &*PORT2.get(),
