...
impl CUR_MOD_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CUR_MOD_A> {
        match self.bits {
            false => Some(CUR_MOD_A::VALUE1),
            _ => None,
        }
    }
...
pub type ERLY_SUSP_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
pub type ENUM_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
pub type ISOOUT_DROP_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
pub type INCOMP_ISOIN_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
pub type INCOMPL_SOOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
...
pub type WK_UP_INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, GINTSTS_SPEC, bool, O>;
impl R {
