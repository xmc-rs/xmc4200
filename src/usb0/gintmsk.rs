...
impl W {
    #[doc = "Bit 3 - Start of Frame Mask"]
    #[inline(always)]
    pub fn sof_msk(&mut self) -> SOF_MSK_W<'_, GINTMSK_SPEC> {
        SOF_MSK_W::new(self, 3)
    }
    #[doc = "Bit 4 - Receive FIFO Non-Empty Mask"]
    #[inline(always)]
    pub fn rx_flvl_msk(&mut self) -> RX_FLVL_MSK_W<'_, GINTMSK_SPEC> {
        RX_FLVL_MSK_W::new(self, 4)
    }
    #[doc = "Bit 6 - Global Non-periodic IN NAK Effective Mask"]
    #[inline(always)]
    pub fn ginnak_eff_msk(&mut self) -> GINNAK_EFF_MSK_W<'_, GINTMSK_SPEC> {
        GINNAK_EFF_MSK_W::new(self, 6)
    }
    #[doc = "Bit 7 - Global OUT NAK Effective Mask"]
    #[inline(always)]
    pub fn goutnak_eff_msk(&mut self) -> GOUTNAK_EFF_MSK_W<'_, GINTMSK_SPEC> {
        GOUTNAK_EFF_MSK_W::new(self, 7)
    }
    #[doc = "Bit 10 - Early Suspend Mask"]
    #[inline(always)]
    pub fn erly_susp_msk(&mut self) -> ERLY_SUSP_MSK_W<'_, GINTMSK_SPEC> {
        ERLY_SUSP_MSK_W::new(self, 10)
    }
    #[doc = "Bit 11 - USB Suspend Mask"]
    #[inline(always)]
    pub fn usbsusp_msk(&mut self) -> USBSUSP_MSK_W<'_, GINTMSK_SPEC> {
        USBSUSP_MSK_W::new(self, 11)
    }
    #[doc = "Bit 12 - USB Reset Mask"]
    #[inline(always)]
    pub fn usbrst_msk(&mut self) -> USBRST_MSK_W<'_, GINTMSK_SPEC> {
        USBRST_MSK_W::new(self, 12)
    }
    #[doc = "Bit 13 - Enumeration Done Mask"]
    #[inline(always)]
    pub fn enum_done_msk(&mut self) -> ENUM_DONE_MSK_W<'_, GINTMSK_SPEC> {
        ENUM_DONE_MSK_W::new(self, 13)
    }
    #[doc = "Bit 14 - Isochronous OUT Packet Dropped Interrupt Mask"]
    #[inline(always)]
    pub fn isoout_drop_msk(&mut self) -> ISOOUT_DROP_MSK_W<'_, GINTMSK_SPEC> {
    ...
    #[doc = "Bit 18 - IN Endpoints Interrupt Mask"]
    #[inline(always)]
    pub fn iepint_msk(&mut self) -> IEPINT_MSK_W<'_, GINTMSK_SPEC> {
        IEPINT_MSK_W::new(self, 18)
    }
    #[doc = "Bit 19 - OUT Endpoints Interrupt Mask"]
    #[inline(always)]
    pub fn oepint_msk(&mut self) -> OEPINT_MSK_W<'_, GINTMSK_SPEC> {
        OEPINT_MSK_W::new(self, 19)
    }
    #[doc = "Bit 20 - Incomplete Isochronous IN Transfer Mask"]
    #[inline(always)]
    pub fn incomp_isoinmsk(&mut self) -> INCOMP_ISOINMSK_W<'_, GINTMSK_SPEC> {
        INCOMP_ISOINMSK_W::new(self, 20)
    }
    #[doc = "Bit 21 - Incomplete Isochronous OUT Transfer Mask"]
    #[inline(always)]
    pub fn incompl_sooutmsk(&mut self) -> INCOMPL_SOOUTMSK_W<'_, GINTMSK_SPEC> {
        INCOMPL_SOOUTMSK_W::new(self, 21)
    }
    #[doc = "Bit 31 - Resume/Remote Wakeup Detected Interrupt Mask"]
    #[inline(always)]
    pub fn wk_up_int_msk(&mut self) -> WK_UP_INT_MSK_W<'_, GINTMSK_SPEC> {
