...
#[doc = "Possible values of the field `LPACCONF`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LPACCONFR {
    #[doc = "Ready"]
    VALUE1,
...
impl LPACCONFR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            LPACCONFR::VALUE1 => false,
            LPACCONFR::VALUE2 => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> LPACCONFR {
        match value {
            false => LPACCONFR::VALUE1,
            true => LPACCONFR::VALUE2,
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
    #[inline]
    pub fn is_value1(&self) -> bool {
        *self == LPACCONFR::VALUE1
    }
    #[doc = "Checks if the value of the field is `VALUE2`"]
    #[inline]
    pub fn is_value2(&self) -> bool {
        *self == LPACCONFR::VALUE2
    }
}
